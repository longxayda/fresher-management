...
import { questionSelectedListChange } from "redux/auditorsSlice/scheduleSlice";
import { questionSelectedListSchedule } from 'redux/selectors/auditorsSelector/scheduleSelector'
...
function TableResource({ columns, data, maxIndexPage, currentPage, setCurrentPage, setInputSearch, inputSearch}) {
  ...
  useEffect(() => {
    dispatch(questionSelectedListChange(selectedFlatRows.map(row => row.original.id)))
